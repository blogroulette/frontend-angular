...
const routes = {
  ...
  upvote_message: (c: MessageVoteContext) => {
    return ({
  ...
  downvote_message: (c: MessageVoteContext) => {
    return ({
      endpoint: '/VoteMessage',
      body: {
        vote: 'down',
  ...
  add_comment: (c: AddCommentContext) => {
    return ({
      endpoint: '/AddComment',
      body: {
        messageid: c.messageid,
  ...
  upvote_comment: (c: CommentVoteContext) => {
    return ({
  ...
  downvote_comment: (c: CommentVoteContext) => {
    return ({
      endpoint: '/VoteComment',
      body: {
        vote: 'down',
